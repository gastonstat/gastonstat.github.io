...
```{r 'plot_dream1', fig.height=4, fig.width=7}
plot(0, 0, type = 'n')
...
```{r 'plot_dream2', fig.height=4, fig.width=7}
...
```{r 'plot_dream3', fig.height=4, fig.width=7}
...
```{r 'plot_dream4', fig.height=4, fig.width=7}
...
```{r 'plot_dream5', fig.height=4, fig.width=7}
...
```{r 'crazy-ones', fig.height=4, fig.width=7}
speech <- c(
