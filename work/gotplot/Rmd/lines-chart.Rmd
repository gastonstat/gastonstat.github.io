...
```{r 'lines-chart-plot', echo=FALSE, eval=FALSE}
# ========================================================
# Plot
# ========================================================
# set graphic margins
...
```{r 'lines-chart-plot', echo=FALSE, fig.width=10, fig.height=6}
```

### R Code

```{r 'lines-chart-data', tidy=FALSE, eval=FALSE,}
```

```{r 'lines-chart-plot', tidy=FALSE, eval=FALSE}
```
