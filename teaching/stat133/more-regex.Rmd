...
6. How would you get the time-value: e.g. `7:55p.m.`?
```{r}
# full time value from x

```

7. How would you get the __times__ (hours and minutes): e.g. `7:55`?
```{r}
# times from x

```

8. How would you get the __time period__: e.g. `p.m.`?
```{r}
# time periods from x
